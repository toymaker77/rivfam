 ...
 *
 */
define('DBASE_USER', 'dbo528549388');
define('DBASE_PASS', 'icom735');
define('DBASE_NAME', 'db528549388');
define('DBASE_SERVER', 'db528549388.db.1and1.com');
define('DBASE_TYPE', 'mysql');

define('TABLE_PREFIX', 'phpvms_');

define('SITE_URL', 'http://rivierefamily.net');
...
Config::Set('PILOTID_OFFSET', 10);	# What # to start pilot ID's from
Config::Set('PILOTID_LENGTH', 2);	# Length of the Pilot ID
...
# Email Settings
Config::Set('EMAIL_FROM_NAME', 'Ross Riviere');
Config::Set('EMAIL_FROM_ADDRESS', 'ross@rivierefamily.net');
